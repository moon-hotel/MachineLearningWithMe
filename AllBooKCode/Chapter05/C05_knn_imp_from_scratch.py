    ...
    def _k_nearest_search(self, point, k):
        ...
        def k_nearest_node_search(point, curr_node, order=0):
            ...
            if n < k:  # 如果当前还没找到k个点，则直接进行保存
                ...
                if d1 < d2:
                    logging.info(f"\t当前节点到被搜索点的距离{round(d1,3)} < 被搜索点到列表中最后一个节点的距离{round(d2,3)}，进行替换")
...
def test_kd_k_nearest_search():
    ...
    logging.info(f"\n{points[ind]}", )
    logging.info(ind)
    # [2024-05-05 09:13:59] - INFO: 当前待划分样本点：[[3.0, 8.0, 1.0], [5.0, 7.0, 0.0], [6.0, 3.0, 2.0], [8.0, 5.0, 3.0], [9.0, 10.0, 7.0], [10.0, 4.0, 5.0], [11.0, 14.0, 8.0], [12.0, 13.0, 6.0], [15.0, 6.0, 4.0]]
    # [2024-05-05 09:13:59] - INFO: 父节点：[ 9. 10.  7.]
    # [2024-05-05 09:13:59] - INFO: 左子树: [[3.0, 8.0, 1.0], [5.0, 7.0, 0.0], [6.0, 3.0, 2.0], [8.0, 5.0, 3.0]]
    # [2024-05-05 09:13:59] - INFO: 右子树: [[10.0, 4.0, 5.0], [11.0, 14.0, 8.0], [12.0, 13.0, 6.0], [15.0, 6.0, 4.0]]
    # [2024-05-05 09:13:59] - INFO: ============
    # [2024-05-05 09:13:59] - INFO: 当前待划分样本点：[[6.0, 3.0, 2.0], [8.0, 5.0, 3.0], [5.0, 7.0, 0.0], [3.0, 8.0, 1.0]]
    # [2024-05-05 09:13:59] - INFO: 父节点：[5. 7. 0.]
    # [2024-05-05 09:13:59] - INFO: 左子树: [[6.0, 3.0, 2.0], [8.0, 5.0, 3.0]]
    # [2024-05-05 09:13:59] - INFO: 右子树: [[3.0, 8.0, 1.0]]
    # [2024-05-05 09:13:59] - INFO: ============
    # [2024-05-05 09:13:59] - INFO: 当前待划分样本点：[[6.0, 3.0, 2.0], [8.0, 5.0, 3.0]]
    # [2024-05-05 09:13:59] - INFO: 父节点：[8. 5. 3.]
    # [2024-05-05 09:13:59] - INFO: 左子树: [[6.0, 3.0, 2.0]]
    # [2024-05-05 09:13:59] - INFO: 右子树: []
    # [2024-05-05 09:13:59] - INFO: ============
    # [2024-05-05 09:13:59] - INFO: 当前待划分样本点：[[6.0, 3.0, 2.0]]
    # [2024-05-05 09:13:59] - INFO: 父节点：[6. 3. 2.]
    # [2024-05-05 09:13:59] - INFO: 左子树: []
    # [2024-05-05 09:13:59] - INFO: 右子树: []
    # [2024-05-05 09:13:59] - INFO: ============
    # [2024-05-05 09:13:59] - INFO: 当前待划分样本点：[[3.0, 8.0, 1.0]]
    # [2024-05-05 09:13:59] - INFO: 父节点：[3. 8. 1.]
    # [2024-05-05 09:13:59] - INFO: 左子树: []
    # [2024-05-05 09:13:59] - INFO: 右子树: []
    # [2024-05-05 09:13:59] - INFO: ============
    # [2024-05-05 09:13:59] - INFO: 当前待划分样本点：[[10.0, 4.0, 5.0], [15.0, 6.0, 4.0], [12.0, 13.0, 6.0], [11.0, 14.0, 8.0]]
    # [2024-05-05 09:13:59] - INFO: 父节点：[12. 13.  6.]
    # [2024-05-05 09:13:59] - INFO: 左子树: [[10.0, 4.0, 5.0], [15.0, 6.0, 4.0]]
    # [2024-05-05 09:13:59] - INFO: 右子树: [[11.0, 14.0, 8.0]]
    # [2024-05-05 09:13:59] - INFO: ============
    # [2024-05-05 09:13:59] - INFO: 当前待划分样本点：[[10.0, 4.0, 5.0], [15.0, 6.0, 4.0]]
    # [2024-05-05 09:13:59] - INFO: 父节点：[15.  6.  4.]
    # [2024-05-05 09:13:59] - INFO: 左子树: [[10.0, 4.0, 5.0]]
    # [2024-05-05 09:13:59] - INFO: 右子树: []
    # [2024-05-05 09:13:59] - INFO: ============
    # [2024-05-05 09:13:59] - INFO: 当前待划分样本点：[[10.0, 4.0, 5.0]]
    # [2024-05-05 09:13:59] - INFO: 父节点：[10.  4.  5.]
    # [2024-05-05 09:13:59] - INFO: 左子树: []
    # [2024-05-05 09:13:59] - INFO: 右子树: []
    # [2024-05-05 09:13:59] - INFO: ============
    # [2024-05-05 09:13:59] - INFO: 当前待划分样本点：[[11.0, 14.0, 8.0]]
    # [2024-05-05 09:13:59] - INFO: 父节点：[11. 14.  8.]
    # [2024-05-05 09:13:59] - INFO: 左子树: []
    # [2024-05-05 09:13:59] - INFO: 右子树: []
    # [2024-05-05 09:13:59] - INFO: ============
    # [2024-05-05 09:13:59] - INFO:
    ...
    #
    # [2024-05-05 09:13:59] - INFO: K近邻搜索当前访问节点为：data([ 9. 10.]),index(7)
    # [2024-05-05 09:13:59] - INFO: 	有序列表中的节点数目为：0 < 3，直接加入新节点并排序
    # [2024-05-05 09:13:59] - INFO: 		当前K近邻有序列表中的节点为（已按距离升序排序）：
    # [2024-05-05 09:13:59] - INFO: 			data([ 9. 10.]),index(7)
    # [2024-05-05 09:13:59] - INFO:
    #
    # [2024-05-05 09:13:59] - INFO: 访问当前节点data([ 9. 10.]),index(7)的左孩子
    # [2024-05-05 09:13:59] - INFO: K近邻搜索当前访问节点为：data([5. 7.]),index(0)
    # [2024-05-05 09:13:59] - INFO: 	有序列表中的节点数目为：1 < 3，直接加入新节点并排序
    # [2024-05-05 09:13:59] - INFO: 		当前K近邻有序列表中的节点为（已按距离升序排序）：
    # [2024-05-05 09:13:59] - INFO: 			data([5. 7.]),index(0)
    # [2024-05-05 09:13:59] - INFO: 			data([ 9. 10.]),index(7)
    # [2024-05-05 09:13:59] - INFO:
    #
    # [2024-05-05 09:13:59] - INFO: 访问当前节点data([5. 7.]),index(0)的左孩子
    # [2024-05-05 09:13:59] - INFO: K近邻搜索当前访问节点为：data([8. 5.]),index(3)
    # [2024-05-05 09:13:59] - INFO: 	有序列表中的节点数目为：2 < 3，直接加入新节点并排序
    # [2024-05-05 09:13:59] - INFO: 		当前K近邻有序列表中的节点为（已按距离升序排序）：
    # [2024-05-05 09:13:59] - INFO: 			data([8. 5.]),index(3)
    # [2024-05-05 09:13:59] - INFO: 			data([5. 7.]),index(0)
    # [2024-05-05 09:13:59] - INFO: 			data([ 9. 10.]),index(7)
    # [2024-05-05 09:13:59] - INFO:
    #
    # [2024-05-05 09:13:59] - INFO: 访问当前节点data([8. 5.]),index(3)的右孩子
    # [2024-05-05 09:13:59] - INFO: K近邻搜索当前访问节点为：None
    # [2024-05-05 09:13:59] - INFO: 回到上一层递归，当前访问节点为 data([8. 5.]),index(3)，开始判断步骤(6)
    # [2024-05-05 09:13:59] - INFO: ** [8. 5.]被搜索点到当前节点划分维度的距离小于列表中最后一个元素到被搜索点的距离，即 |8.0 - 8.9| < 6.001 **
    # [2024-05-05 09:13:59] - INFO: 访问当前节点data([8. 5.]),index(3)的左孩子
    # [2024-05-05 09:13:59] - INFO: K近邻搜索当前访问节点为：data([6. 3.]),index(2)
    # [2024-05-05 09:13:59] - INFO: 	被搜索点[8.9 4. ]到当前节点data([6. 3.]),index(2)的距离为 3.068
    # [2024-05-05 09:13:59] - INFO: 	被搜索点[8.9 4. ]到列表中最后一个节点data([ 9. 10.]),index(7)的距离为 6.001
    # [2024-05-05 09:13:59] - INFO: 	当前节点到被搜索点的距离3.068 < 被搜索点到列表中最后一个节点的距离6.001，进行替换
    # [2024-05-05 09:13:59] - INFO: 		当前K近邻有序列表中的节点为（已按距离升序排序）：
    # [2024-05-05 09:13:59] - INFO: 			data([8. 5.]),index(3)
    # [2024-05-05 09:13:59] - INFO: 			data([6. 3.]),index(2)
    # [2024-05-05 09:13:59] - INFO: 			data([5. 7.]),index(0)
    # [2024-05-05 09:13:59] - INFO:
    #
    # [2024-05-05 09:13:59] - INFO: 访问当前节点data([6. 3.]),index(2)的右孩子
    # [2024-05-05 09:13:59] - INFO: K近邻搜索当前访问节点为：None
    # [2024-05-05 09:13:59] - INFO: 回到上一层递归，当前访问节点为 data([6. 3.]),index(2)，开始判断步骤(6)
    # [2024-05-05 09:13:59] - INFO: ** [6. 3.]被搜索点到当前节点划分维度的距离小于列表中最后一个元素到被搜索点的距离，即 |3.0 - 4.0| < 4.92 **
    # [2024-05-05 09:13:59] - INFO: 访问当前节点data([6. 3.]),index(2)的左孩子
    # [2024-05-05 09:13:59] - INFO: K近邻搜索当前访问节点为：None
    # [2024-05-05 09:13:59] - INFO: 回到上一层递归，当前访问节点为 data([5. 7.]),index(0)，开始判断步骤(6)
    # [2024-05-05 09:13:59] - INFO: ** [5. 7.]被搜索点到当前节点划分维度的距离小于列表中最后一个元素到被搜索点的距离，即 |7.0 - 4.0| < 4.92 **
    # [2024-05-05 09:13:59] - INFO: 访问当前节点data([5. 7.]),index(0)的右孩子
    # [2024-05-05 09:13:59] - INFO: K近邻搜索当前访问节点为：data([3. 8.]),index(1)
    # [2024-05-05 09:13:59] - INFO: 	被搜索点[8.9 4. ]到当前节点data([3. 8.]),index(1)的距离为 7.128
    # [2024-05-05 09:13:59] - INFO: 	被搜索点[8.9 4. ]到列表中最后一个节点data([5. 7.]),index(0)的距离为 4.92
    # [2024-05-05 09:13:59] - INFO: 访问当前节点data([3. 8.]),index(1)的右孩子
    # [2024-05-05 09:13:59] - INFO: K近邻搜索当前访问节点为：None
    # [2024-05-05 09:13:59] - INFO: 回到上一层递归，当前访问节点为 data([3. 8.]),index(1)，开始判断步骤(6)
    # [2024-05-05 09:13:59] - INFO: 回到上一层递归，当前访问节点为 data([ 9. 10.]),index(7)，开始判断步骤(6)
    # [2024-05-05 09:13:59] - INFO: ** [ 9. 10.]被搜索点到当前节点划分维度的距离小于列表中最后一个元素到被搜索点的距离，即 |9.0 - 8.9| < 4.92 **
    # [2024-05-05 09:13:59] - INFO: 访问当前节点data([ 9. 10.]),index(7)的右孩子
    # [2024-05-05 09:13:59] - INFO: K近邻搜索当前访问节点为：data([12. 13.]),index(6)
    # [2024-05-05 09:13:59] - INFO: 	被搜索点[8.9 4. ]到当前节点data([12. 13.]),index(6)的距离为 9.519
    # [2024-05-05 09:13:59] - INFO: 	被搜索点[8.9 4. ]到列表中最后一个节点data([5. 7.]),index(0)的距离为 4.92
    # [2024-05-05 09:13:59] - INFO: 访问当前节点data([12. 13.]),index(6)的左孩子
    # [2024-05-05 09:13:59] - INFO: K近邻搜索当前访问节点为：data([15.  6.]),index(4)
    # [2024-05-05 09:13:59] - INFO: 	被搜索点[8.9 4. ]到当前节点data([15.  6.]),index(4)的距离为 6.42
    # [2024-05-05 09:13:59] - INFO: 	被搜索点[8.9 4. ]到列表中最后一个节点data([5. 7.]),index(0)的距离为 4.92
    # [2024-05-05 09:13:59] - INFO: 访问当前节点data([15.  6.]),index(4)的左孩子
    # [2024-05-05 09:13:59] - INFO: K近邻搜索当前访问节点为：data([10.  4.]),index(5)
    # [2024-05-05 09:13:59] - INFO: 	被搜索点[8.9 4. ]到当前节点data([10.  4.]),index(5)的距离为 1.1
    # [2024-05-05 09:13:59] - INFO: 	被搜索点[8.9 4. ]到列表中最后一个节点data([5. 7.]),index(0)的距离为 4.92
    # [2024-05-05 09:13:59] - INFO: 	当前节点到被搜索点的距离1.1 < 被搜索点到列表中最后一个节点的距离4.92，进行替换
    # [2024-05-05 09:13:59] - INFO: 		当前K近邻有序列表中的节点为（已按距离升序排序）：
    # [2024-05-05 09:13:59] - INFO: 			data([10.  4.]),index(5)
    # [2024-05-05 09:13:59] - INFO: 			data([8. 5.]),index(3)
    # [2024-05-05 09:13:59] - INFO: 			data([6. 3.]),index(2)
    # [2024-05-05 09:13:59] - INFO:
    #
    # [2024-05-05 09:13:59] - INFO: 访问当前节点data([10.  4.]),index(5)的右孩子
    # [2024-05-05 09:13:59] - INFO: K近邻搜索当前访问节点为：None
    # [2024-05-05 09:13:59] - INFO: 回到上一层递归，当前访问节点为 data([10.  4.]),index(5)，开始判断步骤(6)
    # [2024-05-05 09:13:59] - INFO: ** [10.  4.]被搜索点到当前节点划分维度的距离小于列表中最后一个元素到被搜索点的距离，即 |4.0 - 4.0| < 3.068 **
    # [2024-05-05 09:13:59] - INFO: 访问当前节点data([10.  4.]),index(5)的左孩子
    # [2024-05-05 09:13:59] - INFO: K近邻搜索当前访问节点为：None
    # [2024-05-05 09:13:59] - INFO: 回到上一层递归，当前访问节点为 data([15.  6.]),index(4)，开始判断步骤(6)
    # [2024-05-05 09:13:59] - INFO: 回到上一层递归，当前访问节点为 data([12. 13.]),index(6)，开始判断步骤(6)
    # [2024-05-05 09:13:59] - INFO: MyKDTree 运行结果：
    # [2024-05-05 09:13:59] - INFO:
    # [[[10.  4.]
    #   [ 8.  5.]
    #   [ 6.  3.]]]
    # [2024-05-05 09:13:59] - INFO: [[5 3 2]]
    # [2024-05-05 09:13:59] - INFO: sklearn KDTree 运行结果：
    # [2024-05-05 09:13:59] - INFO:
    # [[[10.  4.]
    #   [ 8.  5.]
    #   [ 6.  3.]]]
